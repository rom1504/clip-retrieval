...
* **clip_model** CLIP model to load (default *ViT-B/32*). Specifiy it as `"openclip:Vit-B/32-quickgelu"` to use the [open_clip](https://github.com/mlfoundations/open_clip) models.
